...
function patch(source){
  ...
  // Policy-LP discovery: KIC and strategic-account mandate changes belong in the
  // reporting radar; a naked sovereign-fund keyword does not.
...
function patchApi(source){
  ...
  const next="      const inScope = shouldKeep(item, target, jak.names);\n      // Search filters only the reporting-scope feed; it cannot reopen rejected noise.\n      if (!inScope) continue;";
