...
function main(root=path.resolve(__dirname,'..')){
 ...
 const after=before.replace(/((?:src|href)="\/(?:news-reader(?:-core)?\.js|news-reader\.css|news-taxonomy\.js)[^"]*)"/g,(_,asset)=>asset.replace(/&foreign=[^&"]*/g,'')+'&foreign=20260910-editorial2"');
