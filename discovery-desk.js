...
function card(x){
 ...
 const research=pitch?'<p class="discovery-pitch-reason">'+esc(pitch.reason)+'</p>':'',researchDetails=(B?.renderDetails(x.research,x.clue_id)||'')+(!pitch?(B?.renderBriefHtml(x.research)||''):'');
