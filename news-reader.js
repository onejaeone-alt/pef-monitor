...
function render(){
 ...
 $('#search').placeholder=S.newsScope==='foreign'?'외신 검색 · 영문 기업명·펀드명·기사 제목':'뉴스 검색 · 기업명·펀드명·기사 제목';
