...
const MEDIA = ['edaily.co.kr','thebell.co.kr','dealsite.co.kr','hankyung.com','mk.co.kr','sedaily.com','newsis.com','yna.co.kr','yonhapnewstv.co.kr','platum.kr','venturesquare.net','mt.co.kr','fnnews.com','bloter.net','newstof.com','biz.chosun.com','news1.kr','newspim.com','news.einfomax.co.kr','bizwatch.co.kr'];
...
function htmlBlocks(html,kind='official') {
  ...
  if(core&&clean(decode(core.replace(/<[^>]*>/g,' '))).length<150){
    const bodyNames=/^(articleBody|articleBodyContents|article-view-content-div|newsView_txt|news_view_txt|news_body_area|news_body|newsBody|news_body_content|news_content|news_text|article_body|article-content|article_content)$/i;
