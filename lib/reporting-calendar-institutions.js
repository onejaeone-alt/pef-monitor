...
const INSTITUTIONS=[
 ...
 {id:'lp-tp',name:'사학연금',url:'https://www.tp.or.kr/tp-kr/intro.do',category:'lp'},
 {id:'lp-mmaa',name:'군인공제회',url:'https://www.mmaa.or.kr/',category:'lp'},
 {id:'lp-sema',name:'과학기술인공제회',url:'https://www.sema.or.kr/sema/main/main.do',category:'lp'},
 ...
 {id:'lp-kbiz',name:'중소기업중앙회·노란우산',url:'https://www.kbiz.or.kr/index.do',category:'lp'}
].map(x=>({...x,type:'institution'}));
const INVESTMENT=/벤처|사모(?:펀드|투자|주식|채권|집합투자)|대체투자|해외투자|공동투자|기관투자|국제금융|LP.?GP|모태펀드|농식품.{0,12}(?:투자|펀드)|자본시장|기업금융|구조조정|기업지배|인수.?합병|\bPEF\b|\bVC\b|크레딧|기금운용|자산운용|자산배분|운용(?:계획|전략|성과|수익)|수익률|투자(?:전략|정책|계획|성과|로드쇼)|수탁자책임|스튜어드십|국민(?:참여)?성장펀드|생산적 금융|모험자본|토큰증권|증권|금융투자|PF|IPO|비상장/i;
